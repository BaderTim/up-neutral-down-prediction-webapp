    ...
    render() {
        ...
        return (
            <div className="container"
                ...
                <br/>
                <div>
                <h2 className='lead' style={{float: "left"}}>Latest 8 Predictions {this.state.model.unsure > 0 && (<span style={{color: "grey", fontSize: "15px"}}>(unsure if primary prediction's lead is below {this.state.model.unsure} on a 0-1 prediction scale)</span>)}</h2>
